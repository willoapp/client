...
const createStoreWithFirebase = compose(reactReduxFirebase(firebase, // pass in firebase instance instead of config so we can extend firebase separately like react-native-firebase for native support
reduxConfig, applyMiddleware(
