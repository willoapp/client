...
export const Tabs = TabNavigator({
    ActivityPage: {
        screen: ActivityPage,
        navigationOptions: {
            tabBarIcon: ({ tintColor }) => (React.createElement(Icon, { name: "home", style: { fontSize: 31, color: tintColor } }))
        }
    },
    CalendarPage: {
        screen: CalendarPage,
        navigationOptions: {
            tabBarIcon: ({ tintColor }) => (React.createElement(Icon, { name: "calendar", style: { fontSize: 23, color: tintColor } }))
        }
    },
    MapPage: {
        screen: MapPage,
        navigationOptions: {
            tabBarIcon: ({ tintColor }) => (React.createElement(Icon, { name: "globe", style: { fontSize: 26, color: tintColor } }))
        }
    },
    MessagesPage: {
        screen: MessagesPage,
        navigationOptions: {
            tabBarIcon: ({ tintColor }) => (React.createElement(Icon, { name: "comment", style: { fontSize: 25, color: tintColor } })),
        },
    },
}, {
    // swipeEnabled: true,
...
const RootCardNavigator = StackNavigator({
    Tabs: {
        screen: Tabs,
        navigationOptions: {
            header: (navigator) => (React.createElement(HeaderNav, { onProfilePress: () => {
